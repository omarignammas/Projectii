...
public class TaskController {
    ...
    @GetMapping
    public ResponseEntity<PagingResult<TaskResponse>> getAllTasks(
        ...
        PagingResult<TaskResponse> tasks = taskService.getAllTasks(courseId, request);
